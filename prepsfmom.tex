...
\begin{figure}
    ...
    \caption{
      ...
      empirical scatter in the flux. The bands in each panel show the uncertainties in our
      measurements obtained from bootstrap resampling. For isolated objects with known, white
      pixel noise fields, our reported measurements and errors are correct to
      better than a few percent \mrb{check this a number}.
